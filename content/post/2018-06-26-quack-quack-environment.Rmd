...
There was so much feedback from the workshop last week along the lines of it being great to have more autonomy in the learning process. But I feel without clearer delineation the pseudo code isn't quite there.
...
Pseudo code is where you fill in your own input. [Right now I'm indicating this as `<>` but I'd be interested to see if it's easy to implement font and colour that makes it stand out more.]
...
- The only way to learn to code is to break stuff and mess about. 
