---
title: "so, it would seem I ended up<br/> a mathematical scientist"
subtitle: "charles t. gray"
author: "probus <br/> eltham, melbourne"
date: "`r Sys.Date()`"
output:
...
---
# economic: a precariat existence


```{r}
knitr::include_url("https://en.wikipedia.org/wiki/Precariat")
```
